...
contract('SimpleBank', function (accounts) {
  ...
  it("should withdraw correct amount", async () => {
    ...
    var result = await bank.withdraw(deposit + 1, {
      from: alice
    });
    const balance = await bank.balance({
      from: alice
